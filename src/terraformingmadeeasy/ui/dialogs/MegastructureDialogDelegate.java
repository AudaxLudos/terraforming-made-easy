...
public class MegastructureDialogDelegate extends TMEBaseDialogDelegate {
    ...
    public DropdownPlugin orbitFocusDropdownPlugin = null;
    public TextFieldPlugin startAngleTextFieldPlugin = null;
    public TextFieldPlugin orbitRadiusTextFieldPlugin = null;
    public TextFieldPlugin orbitDaysTextFieldPlugin = null;
    ...
    public void createCustomDialog(CustomPanelAPI panel, CustomDialogCallback callback) {
        ...
        this.orbitFocusDropdownPlugin = new DropdownPlugin(orbitFocusPanel, 190f, 25f, options);
        ...
        this.startAngleTextFieldPlugin = new TextFieldPlugin(startAnglePanel, 190f, 25f);
        ...
        this.orbitRadiusTextFieldPlugin = new TextFieldPlugin(orbitRadiusPanel, 190f, 25f);
        ...
        this.orbitDaysTextFieldPlugin = new TextFieldPlugin(orbitDaysPanel, 190f, 25f);
