...
public class TMEIds {
    ...
    public static final String CONSTRUCTION_GRID = "tme_construction_grid";
    ...
    public static final String CONSTRUCTION_GRID_TECH = "tme_tech_megastructure_engineering";
    public static final String ELEMENT_SYNTHESIZER_TECH = "tme_tech_element_nucleosynthesis";
    public static final String GEOMORPHOLOGY_STATION_TECH = "tme_tech_surface_restructuring";
    public static final String MINERAL_REPLICATOR_TECH = "tme_tech_mineral_transmutation";
    public static final String PLANETARY_HOLOGRAM_TECH = "tme_tech_stellar_topography";
